...
let userName = document.querySelector('#formName'),
    ...
    inputs = document.querySelector('.contact_form__input');
...
userMessg.addEventListener('blur', (e) => {
    e.preventDefault();
...
// Form send
let url = 'https://app.form2chat.io/f/2f2f414';
